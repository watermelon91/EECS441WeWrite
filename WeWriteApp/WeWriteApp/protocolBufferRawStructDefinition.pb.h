...
#ifndef PROTOBUF_protocolBufferRawStructDefinition_2eproto__INCLUDED
#define PROTOBUF_protocolBufferRawStructDefinition_2eproto__INCLUDED
...
class EventBuffer : public ::google::protobuf::Message {
 public:
  ...
  inline ::google::protobuf::int32 participantid() const;
  inline void set_participantid(::google::protobuf::int32 value);
  ...
  static const int kLengthUsedFieldNumber = 4;
 ...
 private:
  ...
  ::google::protobuf::int32 participantid_;
  ...
  friend void  protobuf_AddDesc_protocolBufferRawStructDefinition_2eproto();
  friend void protobuf_AssignDesc_protocolBufferRawStructDefinition_2eproto();
  friend void protobuf_ShutdownFile_protocolBufferRawStructDefinition_2eproto();
...
// required int32 participantID = 1;
inline bool EventBuffer::has_participantid() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void EventBuffer::set_has_participantid() {
  _has_bits_[0] |= 0x00000001u;
}
inline void EventBuffer::clear_has_participantid() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void EventBuffer::clear_participantid() {
  participantid_ = 0;
  clear_has_participantid();
}
inline ::google::protobuf::int32 EventBuffer::participantid() const {
  return participantid_;
}
inline void EventBuffer::set_participantid(::google::protobuf::int32 value) {
...
#endif  // PROTOBUF_protocolBufferRawStructDefinition_2eproto__INCLUDED
